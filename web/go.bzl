...
def go_web_test_suite(name,
  ...
  Any attribute for go_test is supported by go_web_test_suite. If the
  argument isn't listed below, then the argument values have the same
  exact meaning as in go_test.
  ...
  Args:
    ...
    **remaining_keyword_args: Arguments for go_test
  """
  go_test_name = name + "_wrapped_test"
