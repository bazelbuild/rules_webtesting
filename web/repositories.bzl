...
def cglib_nodep():
  java_import_external(
      name="cglib_nodep",
      jar_sha256=
      "b40d7ac4400ea21dcf818f436a346ddd66b67c550811ccac5bbcbec095ab1287",
      jar_urls=[
...
def com_google_errorprone_error_prone_annotations():
  java_import_external(
      ...
      jar_sha256=
      "e7749ffdf03fb8ebe08a727ea205acb301c8791da837fee211b99b04f9d79c46",
      jar_urls=[
...
def org_apache_httpcomponents_httpcore():
  java_import_external(
      ...
      jar_sha256=
      "f7bc09dc8a7003822d109634ffd3845d579d12e725ae54673e323a7ce7f5e325",
      jar_urls=[
...
def org_apache_httpcomponents_httpmime():
  java_import_external(
      ...
      jar_sha256=
      "231a3f7e4962053db2be8461d5422e68fc458a3a7dd7d8ada803a348e21f8f07",
      jar_urls=[
...
def org_mozilla_firefox():
  platform_http_file(
      ...
      amd64_sha256=
      "10533f3db9c819a56f6cd72f9340e05c7e3b116454eb81b0d39ed161955bb48f",
      amd64_urls=[
...
def org_mozilla_geckodriver():
  platform_http_file(
      ...
      amd64_sha256=
      "ce4aa8b5cf918a6607b50e73996fb909db42fd803855f0ecc9d7183999c3bedc",
      amd64_urls=[
...
def org_seleniumhq_selenium_api():
  java_import_external(
      ...
      jar_sha256=
      "0226cc02880aff06f7fd85e77314182087a524e21ceda02f8197317bbb0390b8",
      jar_urls=[
...
def org_seleniumhq_selenium_remote_driver():
  java_import_external(
      ...
      jar_sha256=
      "97eed1fe99c4b5ced127336270fe56fa53754627f24536bc07141c6451270275",
      jar_urls=[
