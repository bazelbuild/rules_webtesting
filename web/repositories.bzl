...
def org_chromium_chromedriver():
  platform_http_file(
      ...
      amd64_urls = ["http://chromedriver.storage.googleapis.com/2.26/chromedriver_linux64.zip"],
      macos_sha256 = "70aae3812941ed94ad8065bb4a9432861d7d4ebacdd93ee47bb2c7c57c7e841e",
      macos_urls = ["http://chromedriver.storage.googleapis.com/2.26/chromedriver_mac64.zip"]
  )
...
def org_chromium_chromium():
  ...
  platform_http_file(
      ...
      amd64_urls = ["http://commondatastorage.googleapis.com/chromium-browser-snapshots/Linux_x64/423768/chrome-linux.zip"],
      macos_sha256 = "62aeb7a5c6b8a1b7b31400105bf01295bbd45b0627920b8f99f0cc4ca76927ca",
      macos_urls = ["http://commondatastorage.googleapis.com/chromium-browser-snapshots/Mac/423758/chrome-mac.zip"],
  )
