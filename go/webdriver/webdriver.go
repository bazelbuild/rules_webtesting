...
type WebDriver interface {
	...
	// KeyDown performs key presses to the active element.
...
// KeyDown performs key presses to the active element.
func (d *webDriver) KeyDown(ctx context.Context, keys string) error {
	return d.keyAction(ctx, "keyDown", keys)
}

// KeyUp releases depressed keys.
func (d *webDriver) KeyUp(ctx context.Context, keys string) error {
	return d.keyAction(ctx, "keyUp", keys)
}

func (d *webDriver) keyAction(ctx context.Context, action string, keys string) error {
	...
	return d.post(ctx, "actions", map[string]interface{}{
		"actions": []interface{}{
